        ...
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">ระบบจัดการข้อมูลผู้สมัคร</p>
                </div>
            </div>
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ url('/admission') }}" class="text-blue-600 hover:text-blue-800">
                    <i class="fas fa-arrow-left mr-1"></i> ระบบรับสมัคร
                </a>
            </div>
        </div>
    </header>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('admin.export') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded text-sm">
                        <i class="fas fa-download mr-1"></i> Export CSV
                    </a>
                    <button onclick="refreshData()" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded text-sm">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                        <button data-applicant-id="{{ $applicant->id }}" 
                                                class="view-btn text-blue-600 hover:text-blue-900">
