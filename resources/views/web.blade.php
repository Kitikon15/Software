        ...
        <aside class="w-64 bg-gray-700 min-h-screen">
            <div class="p-4">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ url('/forgot')}}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">เปลี่ยนรหัสผ่าน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ประวัตินักศึกษา</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">แสดงหลักสูตร</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ผลการลงทะเบียน/ใบแจ้งชำระเงิน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ตารางเรียนตามแผนการเรียน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ตารางเรียนที่ นศ.ลงทะเบียน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ตารางค่าใช้จ่าย/ทุน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">พิมพ์ใบเสร็จ</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ผลการศึกษา</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ประเมินการสอน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">รายชื่อคศ./ตารางเรียนรายภาค</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ค้นหารายวิชา</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ค้นหาตารางเรียน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ค้นหาตารางสอน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">แผนการเรียน</a>
                    <a href="{{ url('/') }}" class="block text-white hover:bg-gray-600 px-3 py-2 rounded">ค้นหาตารางการใช้ห้อง</a>
                </nav>
            </div>
        </aside>
